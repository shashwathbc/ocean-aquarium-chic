...
export default function CategoriesPage() {
    ...
    const handleStatusToggle = (id: string, currentStatus: boolean) => {
        // Find existing category to keep slug/name identical on update
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {isLoading ? (
                                ...
                                categories.map((cat) => (
                                    <tr key={cat._id} className="hover:bg-muted/50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="relative inline-flex">
                                                <select
                                                    ...
                                                    onChange={(e) => handleStatusToggle(cat._id, cat.isActive)}
                                                    className={`appearance-none outline-none border-none cursor-pointer pl-3 pr-6 py-1 text-xs font-bold rounded-full focus:ring-2 focus:ring-offset-1 focus:ring-offset-background focus:ring-primary/50 transition-colors ${cat.isActive
                                                ...
                                                <div className="pointer-events-none absolute inset-y-0 right-1.5 flex items-center">
                                                    <svg className={`h-3 w-3 ${cat.isActive ? "text-primary" : "text-gray-500"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <td className="px-6 py-4 text-gray-500 font-medium">
                                            0 {/* We can aggregate real product counts later */}
                                        </td>
