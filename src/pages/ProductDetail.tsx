    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 md:pt-28 pb-20">
        <div className="container mx-auto px-4">
          <Link to="/shop" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors mb-8 font-display text-base">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            >
              <div className="rounded-3xl overflow-hidden aspect-square md:aspect-[4/3] relative bg-muted flex items-center justify-center shadow-lg border border-border/50">
                {media[activeMedia].type === 'video' ? (
                  <video src={media[activeMedia].url} autoPlay loop muted playsInline className="w-full h-full object-cover" />
                ) : (
                  <img src={media[activeMedia].url} alt={product.name} className="w-full h-full object-cover" />
                )}
              </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-2">
                ...
                <Link to="/checkout" className="flex-1 flex">
                  <Button
                    variant="coral"
                    size="lg"
